-- Delete user akshay@uhcstaffing.com and all associated data
DO $$
DECLARE
  v_user_id uuid;
BEGIN
  ...
  FROM auth.users
  WHERE email = 'akshay@uhcstaffing.com';
  ...
  IF v_user_id IS NOT NULL THEN
    ...
    RAISE NOTICE 'User akshay@uhcstaffing.com and all associated data deleted successfully';
  ELSE
    RAISE NOTICE 'User akshay@uhcstaffing.com not found';
  END IF;
END $$;