 ...
 import { FileText, CheckCircle2, Clock, XCircle, RefreshCw } from "lucide-react";
   ...
   return (
     <Card>
       <CardHeader>
         ...
         <CardDescription>
           {templates.length} templates synced from Exotel
         </CardDescription>
       </CardHeader>
       <CardContent>
         {templates.length === 0 ? (
           <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
             ...
             <p className="text-xs">Click "Sync Templates" to fetch from Exotel</p>
           </div>
         ) : (
